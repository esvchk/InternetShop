...
import com.academy.course.service.validator.BasePaginationValidation;
...
public class ProductServiceImpl extends PaginatedResult<ProductDTO> implements ProductService {
    ...
    public ProductServiceImpl(ProductDAO productDAO, ProductMapper productMapper, IdValidatorFactory idValidatorFactory, BaseProductValidator baseProductValidator, BusinessProductValidator businessProductValidator, BasePaginationValidation basePaginationValidation) {
    ...
    public PaginatedResult<ProductDTO> getPaginatedListOfProducts(int offset, int size) {
        ...
        basePaginationValidation.validatePagination(offset,size,totalSize,products.size());
    ...
    public void updateProduct(Integer oldValueId, ProductDTO newValue) throws SQLException {
        ...
        setProductLimit(oldValueId, newValue.getProductLimit());
        productDAO.update(product);
    ...
    public Set<ProductDTO> findProductsByName(String name) {
        ...
        logger.info("Products with name {} was successfully found", name);
        return productMapper.mapToSetDTOS(productDAO.getByName(name));
    }
